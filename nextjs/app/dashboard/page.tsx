    ...
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <section className="mt-10 space-y-3">
        ...
        <p className="text-sm text-neutral-600 dark:text-neutral-400">
          ...
          (or, locally, from the session cookie) and forwarded the user ID. This page used the
          server-side <code className="rounded bg-neutral-200/60 px-1 dark:bg-neutral-800">FORTE_API_TOKEN</code> to fetch the user record.
        </p>
